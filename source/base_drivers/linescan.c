...
void LineCamProcess(void)
{
	...
	if( LCqueue != 0 )
    {
        ...
        else
        {
        	...
        	memcpy((uint16_t  *)LCptr, (uint16_t  *)LCamData, 256);  					// Copy the actual data
...
//============================================================================================================
#if 0
const float CosTable[128] = {1.000000000, 0.999971879, 0.999887518, 0.999746922, 0.999550098, 0.999297058, 0.998987816 , 0.998622389,
							0.998200798, 0.997723067, 0.997189221, 0.996599293, 0.995953314, 0.995251320, 0.994493353, 0.993679453,
							0.992809667, 0.991884044, 0.990902635, 0.989865497, 0.988772687, 0.987624267, 0.986420301, 0.985160857,
							0.983846006, 0.982475822, 0.981050382, 0.979569766, 0.978034057, 0.976443342, 0.974797710, 0.973097254,
							0.971342070, 0.969532255, 0.967667913, 0.965749147, 0.963776066, 0.961748780, 0.9596674040,0.957532055,
							0.955342853, 0.95309992,  0.950803384, 0.948453373, 0.946050019, 0.943593458, 0.941083828, 0.938521269,
							0.935905927, 0.933237947, 0.930517481, 0.927744681, 0.924919703, 0.922042706, 0.919113852, 0.916133305,
							0.913101233, 0.910017807, 0.906883201, 0.903697589, 0.900461152, 0.897174072, 0.893836533, 0.890448723 };
#endif
